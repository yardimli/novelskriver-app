document.addEventListener('DOMContentLoaded', () => {
	...
	// MODIFIED: Removed reference to the prompt editor button, which no longer exists on this page.
	...
	// MODIFIED: Removed event listener for the prompt editor button.
